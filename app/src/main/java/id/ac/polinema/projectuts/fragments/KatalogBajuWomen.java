...
public class KatalogBajuWomen extends Fragment {
    ...
    public static KatalogBajuWomen newInstance(String nama, String warna, String ukuran) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nama_otp.setText("Nama Barju : " + nama_bj);
        warna_otp.setText("Warna Baju : " + warna_bj);
        ukuran_otp.setText("Ukuran Baju : "  + ukuran_bj);
        return view;
    }
